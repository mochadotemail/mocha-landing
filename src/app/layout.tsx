...
export default function RootLayout({
  ...
  return (
    ...
    >
      <head />
      <body
        className={`${inter.variable} ${instrumentSerif.variable} antialiased relative overflow-hidden`}
        style={{ height: "auto", overflow: "auto" }}
      >
        {/* Global subtle paper texture background */}
        <div
          className="pointer-events-none absolute inset-0 -z-10 bg-cover bg-center opacity-15 dark:opacity-5"
          style={{
            backgroundImage:
